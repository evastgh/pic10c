...
namespace std {
    ...
    public:
        ...
        GenericArray(const string& name, Type entry) : Base(name) {
...
//        GenericArrayBase* vec1 = new GenericArray<double, 10>("Double10Arr", 3.14);
                    // with this give us postfix "double & 10" or "fixed size 10" ???
